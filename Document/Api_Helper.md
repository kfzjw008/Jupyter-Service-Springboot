...
### http://Main/api/rank/AllQuestion
总练习量排行榜
...
| 序号 | 参数名 | 参数类型 |解释 |
| ------ | ------ | ------ | ------ |
|1|nickname | String |用户昵称/
|1|allquestion | int |用户总练习数量/



### http://Main/api/rank/CorrectRate
总正确率排行榜
